...
namespace ShiftCloneEffectPlugin
{
    ...
    public class ShiftCloneEffect : VideoEffectBase
    {
        ...
        /// </summary>
        [Display(GroupName = "時間差複製", Name = "手前に複製", Description = "ON：クローンが手前に重なっていく。\nOFF：クローンが奥に重なっていく。")]
        [ToggleSlider]
        public bool Order { get => order; set => Set(ref order, value); }
        bool order = true;

        [Display(GroupName = "時間差複製", Name = "X成分間隔", Description = "X成分間隔")]
        [AnimationSlider("F1", "px", -500, 500)]
        public Animation X { get; } = new Animation(0, -10000, 10000);

        [Display(GroupName = "時間差複製", Name = "Y成分間隔", Description = "Y成分間隔")]
        [AnimationSlider("F1", "px", -500, 500)]
        public Animation Y { get; } = new Animation(0, -10000, 10000);

        [Display(GroupName = "時間差複製", Name = "表示時間間隔", Description = "表示時間間隔。\n0ミリ秒で単純複製します。")]
        ...
        [Display(GroupName = "時間差複製", Name = "総表示個数", Description = "総表示個数")]
        ...
        [Display(GroupName = "時間差複製", Name = "初期追加個数", Description = "初期追加個数")]
        [TextBoxSlider("F0", "個", 0, 10)]
        [DefaultValue(0)]
        [Range(0, 255)]
        ...
        [Display(GroupName = "時間差複製", Name = "初期半透明化", Description = "初期半透明化")]
        [ToggleSlider]
        public bool BeginOp { get => beginOp; set => Set(ref beginOp, value); }
        bool beginOp = false;

        [Display(GroupName = "時間差複製", Name = "フェードイン", Description = "フェードイン")]
        ...
        [Display(GroupName = "時間差複製", Name = "フェードアウト", Description = "フェードアウト")]
        [TextBoxSlider("F2", "秒", 0, 1)]
        [DefaultValue(0d)]
        [Range(0, 10)]
        ...
        [Display(GroupName = "時間差複製", Name = "消去モード", Description = "消去モード")]
        [EnumComboBox]
        ...
        [Display(GroupName = "時間差複製", Name = "消去時間間隔", Description = "消去時間間隔。\n0ミリ秒で消去なし。")]
        [TextBoxSlider("F1", "ミリ秒", 0, 500)]
        [DefaultValue(0d)]
        [Range(0, 10000)]
        ...
        [Display(GroupName = "時間差複製", Name = "終了直後個数", Description = "終了直後個数")]
        [TextBoxSlider("F0", "個", 0, 10)]
        [DefaultValue(0)]
        [Range(0, 255)]
        ...
        [Display(GroupName = "時間差複製", Name = "終了半透明化", Description = "終了半透明化")]
        [ToggleSlider]
